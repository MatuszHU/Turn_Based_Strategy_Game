...
|  2  | **Iron Wall Formation** | Buff    | For 3 turns, increases Defense and Resistance.   | + 10 DEF, + 10 RES  | 3        |
...
|  5  | **Aegis Charge**        | Shield  | Greatly rases defense for 1 turn.                | 90% dmg reduction   | 6        |

## Wizard

|  #  | Ability Name       | Type    | Description                                  | Damage / Effect    | Cooldown |
| :-: | ------------------ | ------- | -------------------------------------------- | ------------------ | -------- |
|  1  | **Flame Orb**      | Damage  | Single-target magic damage.                  | 110% MAG           | 2        |
|  2  | **Frost Shard**    | Damage  | Single-target magic damage.                  | 110% MAG           | 3        |
...
|  5  | **Meteor Burst**   | Damage  | Strong single-target magic damage.           | 160% MAG           | 6        |
...
|  3  | **Blessing**           | Buff         | For 3 turns, increases all stats.            | + 10 ATK/DEF/MAG/RES/ACC/EVA | 3        |
|  4  | **Divine Fortitude**   | Passive      | Permanently increases base Resistance by 10. | + 10 RES                     | -        |
|  5  | **Divine Restoration** | Heal         | Fully heal an ally.                          | Restore 50% HP               | 6        |
